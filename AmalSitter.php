        ...
        <div class="container">
                         ...
                         <div class="personalInfo">
                                   ...
                                   <p class="titlehead">Personal Information</p>
                                              ...
                                              <img class="profile-photo" src="images\profileIcon.png" alt="profile-photo"><!--??-->
                                             
                                              <!--img class="overallrating" src="BSP-img/fullstars.png"  alt="stars"-->
                                             
                                              <p class="bio">"Hi, I'm Aml, and I've been babysitting for a family with two children, 
                                                ages three and five, for the past year. I'm currently in my senior year of high school 
                                                and plan to attend King Saud University in the fall to work toward a business degree. 
                                                I am available on Friday and Saturday evenings and would be delighted to watch your children." </p> <!--should we remov itfrom ul???++img dont forget-->
                                      ...
                                      <ul>
                                                  ...
                                                  <li>Amal</li>
                                                         ...
                                                         <li> Riyadh</li>             
                                                         <li>Contact info:<ul>
                                                           <li><span class="contactlist" ><!--a class="contactinfo" href=""--> 0545111332 </span></li>
                                                           <li><span class="contactlist" ><a class="contactinfo" id="mail" href="mailto:AmlWorld@gmail.com"> AmlWorld@gmail.com</a></span></li>
                                                                  </ul></li>   
               ...
               <div class="FirstReview">
                                       ...
                                       <!--div class="rating"-->
                                                 <img class="rating" src="images\fullstars.png" alt="fullstar">
                                              <!-- end div-->
                  ...
                  <div class ="review">
                                                 perfect, my son loves her!
                  </div>
              
 
               </div>
                                  
                                    <!--We were a bit nervous since it had been so long since we had used a sitter because of the pandemic.
                                                 But the kids are still talking about her. We will definitely use you again!-->
