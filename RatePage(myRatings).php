    ...
    <body>
       ...
       <!-- <header>
        ...
        <div class="BigSpace">
            ...
            <div class="SmallForRating1" >
<p class="Parent1Rate"> She is great with kids </p>
<div class="forpic1"> <!--pic-->
                    <img class="starpic1" src="images\half.png" height="40" width="100" alt="Kidpic">
                </div>
            </div>
            <div class="SmallForRating2">
                <p class="Parent2Rate"> I would totally hire her again she is really kind and my son loved her </p>
                <div class="forpic2"> <!--pic-->
                    <img class="starpic1" src="images\full.png" height="40" width="100" alt="Kidpic">
                </div>
            </div>
        </div><!--BigSpaceEnd-->
        <!--sidebar-->
