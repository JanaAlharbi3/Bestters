        ...
        <div class="container">
                         ...
                         <div class="personalInfo">
                                   ...
                                   <p class="titlehead">Personal Information</p>
                                              ...
                                              <p class="bio">"I have experience preparing meals for children with dietary restrictions, and I am certified in CPR and basic first aid. 
                                                When I'm not in school or babysitting, I enjoy playing basketball and video games. 
                                                I'd love the opportunity to get to know your family and would be happy to provide references if requested." </p> <!--should we remov itfrom ul???++img dont forget-->
                                      ...
                                      <ul>
                                                  ...
                                                  <li>Nora</li>
                                                         ...
                                                         <li> Riyadh</li>             
                                                         <li>Contact info:<ul>
                                                           <li><span class="contactlist" ><!--a class="contactinfo" href=""--> 0544111332 </span></li>
                                                           <li><span class="contactlist" ><a class="contactinfo" id="mail" href="mailto:noraWorld@gmail.com"> noraWorld@gmail.com</a></span></li>
                                                                  </ul></li>   
